...
\x1b[1;33m################################################################
\033[1;34mFACEBOOK: https://m.me/100078833520452
\033[1;35mGITHUB: JAAT-BRAND
\033[1;36mAUTHOR: JULMI JAAT
\033[1;33mTEAM: JAAT CYBER
\x1b[1;34m################################################################
...
while True:
    ...
    try:
        ...
        delay = int(input("\033[92mENTER DEPLY SECOND :: "))  # Bright Green color for input prompt
        ...
        while True:
            ...
            try:
                ...
                if '\'id\':' in str(response2):
                    ...
                    print("\033[92mDATA TIME ::", time.strftime("%Y-%m-%d %H:%M:%S"))  # Date time

                    print("\033[92mJULMI JAAT BRAND ::", comment_with_name)  # Comment sent with name
